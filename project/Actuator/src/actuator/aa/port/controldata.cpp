    ...
    namespace aa
    {
        namespace port
        {
            ...
            ControlData::ControlData()
                : m_logger(ara::log::CreateLogger("ACTR", "PORT", ara::log::LogLevel::kVerbose)), m_running{false}, m_found{false}
            {
            }
            ...
            void ControlData::Find(ara::com::ServiceHandleContainer<deepracer::service::controldata::proxy::SvControlDataProxy::HandleType> handles, ara::com::FindServiceHandle findHandle)
            {
                ...
                else
                {
                    ...
                    {
                        m_logger.LogVerbose() << "ControlData::Find::Searched Instance::ServiceId =" << handle.GetServiceHandle().serviceId << ", InstanceId =" << handle.GetServiceHandle().instanceId;
                    }
                }
                ...
                {
                    m_logger.LogVerbose() << "ControlData::Find::Using Instance::ServiceId =" << handles[0].GetServiceHandle().serviceId << ", InstanceId =" << handles[0].GetServiceHandle().instanceId;
